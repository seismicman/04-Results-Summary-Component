...
Although this is a project that mainly we can develop in HTML and CSS, I developed it in React as an unique component and CSS for the styles. The most important part was how to get the data from the JSON file, manipulate the data using "usestate", make the average calculations and put all the categories with their values. Also, it was very useful to understand Flexbox to organize the different components of the User Interface.
